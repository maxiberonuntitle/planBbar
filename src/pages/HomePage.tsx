          ...
          <div className="grid gap-10 lg:grid-cols-3 lg:items-start">
            ...
            <div className="grid gap-6 lg:col-span-2">
              {[
                ...
                <div key={item.title} className="rounded-3xl border border-white/10 bg-black/70 p-8">
        ...
        <section className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-10 backdrop-blur-xl">
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={item} className="rounded-3xl bg-black/70 p-6">
          ...
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-10 backdrop-blur-xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="aspect-[4/3] rounded-3xl bg-[url('https://images.unsplash.com/photo-1498654896293-37aacf113fd9?auto=format&fit=crop&w=800&q=80')] bg-cover bg-center" />
              <div className="aspect-[4/3] rounded-3xl bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80')] bg-cover bg-center" />
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[32px] border border-white/10 bg-white/5 p-10 backdrop-blur-xl">
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            {[
              ...
              <div key={event.title} className="rounded-3xl border border-white/10 bg-black/70 p-8">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.author} className="rounded-3xl border border-white/10 bg-black/70 p-8">
