    ...
    <footer className="border-t border-white/10 bg-black py-10 text-cream" role="contentinfo">
      <div className="mx-auto flex max-w-7xl flex-col gap-10 px-6 lg:flex-row lg:items-start lg:justify-between lg:px-8">
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm leading-7 text-white/80">{t('footer.description')}</p>
        </div>

        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-gold">{t('footer.contact')}</h3>
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-gold">{t('footer.schedule')}</h3>
            <p className="text-sm text-white/70">{t('footer.scheduleHours')}</p>
          </div>
          <div className="space-y-2">
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-gold">{t('footer.social')}</h3>
            <a
